...
state_history, covariance_history = lkf.run(initial_state_estimate, np.zeros_like(initial_state_estimate), a_priori_covariance, measurements, R=R, max_iterations=10, convergence_threshold=1e-4)
