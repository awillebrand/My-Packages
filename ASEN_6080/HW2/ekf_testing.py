...
P_0 = np.diag([1, 1, 1, 1e-3, 1e-3, 1e-3, 1e-12])**2
...
estimated_state_history, covariance_history, residuals_df = ekf.run(initial_state_guess, np.zeros(7), P_0, measurement_data, R=np.diag(noise_var), start_mode='warm', start_length=1000)
