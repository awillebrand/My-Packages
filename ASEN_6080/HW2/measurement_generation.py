...
time_list = np.arange(0, 25 * period, 10)
time_vector, state_history = integrator.integrate_eom(25*period, initial_state, teval=time_list)
...
measurement_data_frame.to_pickle("ASEN_6080/HW2/measurement_data/simulated_measurements_long.pkl")
...
truth_data_frame.to_pickle("ASEN_6080/HW2/measurement_data/truth_data_long.pkl")