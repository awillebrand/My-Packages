...
estimated_state_history, covariance_history, residuals_df = lkf.run(initial_state_guess, np.zeros(7), P_0, measurement_data, R=np.diag(noise_var), max_iterations=1)
...
state_errors = estimated_state_history[0:6,:] - truth_state_history
