...
residual_df_list = [lkf_residuals_df_eci, ekf_residuals_df_eci]
filter_names = ['LKF with SNC', 'EKF with SNC', 'LKF with SNC', 'EKF with SNC']
...
fig.update_layout(title_text="LKF Position Errors with SNC Process Noise Approach",
                    ...
                    legend=dict(font=dict(size=27),
                                ...
                                x=0.7,
                                itemsizing='constant'))
fig.write_html(f"ASEN_6080/HW3/figures/lkf_position_errors_snc.html")
...
fig.update_layout(title_text="EKF Position Errors with SNC Process Noise Approach",
                    ...
                    legend=dict(font=dict(size=27),
                                ...
                                x=0.7,
                                itemsizing='constant'))
fig.write_html(f"ASEN_6080/HW3/figures/ekf_position_errors_snc.html")
...
fig.update_layout(title_text="LKF Velocity Errors with SNC Process Noise Approach",
                    ...
                    legend=dict(font=dict(size=27),
                                ...
                                x=0.7,
                                itemsizing='constant'))
fig.write_html(f"ASEN_6080/HW3/figures/lkf_velocity_errors_snc.html")
