...
for sigma in sigma_values:
    ...
    for residuals_df, filter_name in zip(residual_df_list, filter_names):
        ...
        for k in range(lkf_state_history.shape[1]):
            lkf_state_errors[:,k] = lkf_state_history[:,k] - truth_data['augmented_state_history'].values[k][0:10]
            ekf_state_errors[:,k] = ekf_state_history[:,k] - truth_data['augmented_state_history'].values[k][0:10]
