...
import numpy as np
from Testing_Scripts.initial_conditions import mu, r_LMO, raan_LMO, inc_LMO, ta_LMO, ta_dot_LMO
...
def hill_frame_dcm(time):
    ...
    pos, vel = get_orbit_state(r_LMO, raan_LMO, inc_LMO, ta_LMO + ta_dot_LMO * time)
    ...
    DCM = np.array([r_hat, theta_hat, h_hat]).T
